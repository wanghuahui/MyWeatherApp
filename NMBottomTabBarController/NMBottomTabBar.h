...
-(void)configureTabAtIndex : (NSInteger)index andTitleOrientation : (NMTitleOrientation)titleOrientation withUnselectedBackgroundImage : (UIImage *)backImage selectedBackgroundImage : (UIImage *)selecetedBackImage iconImage : (UIImage *)iconImage iconSelectedImage: (UIImage *)iconSelectedImage andText : (NSString *)text andTextFont:(UIFont *)font andFontColour:(UIColor *)color;
